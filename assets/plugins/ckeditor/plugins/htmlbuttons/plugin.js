...
CKEDITOR.config.htmlbuttons =	[
	{
		name:'header',
		icon:'icon1.png',
		html:'Name: John Loe Doe,<br>Age: 26<br>Address: Wireless ,Subang Daku, Mandue City<br>',
		title:'Header'
	},
	{
		name:'rx',
		icon:'icon2.png',
		html:'Name: John Loe Doe,<br>Age: 26<br>Address: Wireless ,Subang Daku, Mandue City<br>Rx Header',
		title:'Rx Header'
	}
	// {
	// 	name:'divs',
